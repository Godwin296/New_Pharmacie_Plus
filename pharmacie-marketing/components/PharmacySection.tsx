      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-6 gap-5">
          ...
          <Reveal className="md:col-span-4 md:row-span-2">
            <div className="h-full rounded-[28px] bg-white border border-slate-200/70 p-8 shadow-sm">
          ...
          <Reveal delay={0.05} className="md:col-span-2">
            <div className="h-full rounded-[28px] bg-[var(--color-ink)] p-7 shadow-sm">
          ...
          <Reveal delay={0.1} className="md:col-span-2">
            <div className="h-full rounded-[28px] bg-white border border-slate-200/70 p-7 shadow-sm">
