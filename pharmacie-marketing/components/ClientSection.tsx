...
export function ClientSection() {
  return (
    <section id="clients" className="relative bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="grid lg:grid-cols-[0.85fr_1.15fr] gap-16 items-start">
          <Reveal>
            ...
            <div className="mt-8 rounded-2xl bg-[var(--color-mist)] border border-emerald-100 p-6">
              <p className="text-[14px] text-slate-600 leading-relaxed">
                <strong className="text-[var(--color-ink)]">Votre pharmacie n&apos;est pas encore
            ...
            <div className="space-y-4">
              {steps.map((step, i) => (
                <Reveal key={step.n} delay={i * 0.08}>
                  <div className="relative flex gap-5 rounded-3xl border border-slate-200/70 bg-white p-6 hover:border-emerald-200 transition-colors">
                    <div className="relative z-10 shrink-0 h-14 w-14 rounded-2xl bg-[var(--color-mist)] border border-emerald-100 flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <h3 className="font-display font-bold text-[17px] text-[var(--color-ink)] mt-0.5">
                        {step.title}
                      </h3>
